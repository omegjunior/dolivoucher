...
This project contains the full sources of DoliVoucher, a module for the Dolibarr ERP and CRM application.
...
- ❌ Never commit directly to `main` without a reviewed PR
